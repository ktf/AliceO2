...
if(ENABLE_CUDA)
  ...
  if(CMAKE_CUDA_COMPILER)
    ...
    if(NOT $<CONFIG:Debug>)
      set(CMAKE_CUDA_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}> "${CMAKE_CUDA_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>} -Xcompiler \"${CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>}\" -Xptxas -O4 -Xcompiler -O4")
    endif()
    ...
    if(DEFINED GPUCA_NO_FAST_MATH AND "${GPUCA_NO_FAST_MATH}")
      set(CMAKE_CUDA_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}> "${CMAKE_CUDA_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>} ${GPUCA_CUDA_NO_FAST_MATH_FLAGS}")
    elseif(NOT $<CONFIG:Debug>)
      set(CMAKE_CUDA_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}> "${CMAKE_CUDA_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>} -use_fast_math --ftz=true")#
    endif()
...
if(ENABLE_HIP)
  ...
  if(hip_FOUND AND hipcub_FOUND AND rocthrust_FOUND AND rocprim_FOUND AND hip_HIPCC_EXECUTABLE AND hip_HIPIFY_PERL_EXECUTABLE)
    ...
    set(CMAKE_HIP_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}> "${CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>} ${CMAKE_HIP_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>}")
  else()
    set(HIP_ENABLED OFF)
  endif()
