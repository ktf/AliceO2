...
if(ENABLE_CUDA)
  ...
  if(CMAKE_CUDA_COMPILER)
    ...
    if(NOT BUILD_TYPE_UPPER STREQUAL "DEBUG")
      set(CMAKE_CUDA_FLAGS_${BUILD_TYPE_UPPER} "${CMAKE_CUDA_FLAGS_${BUILD_TYPE_UPPER}} -Xcompiler \"${CMAKE_CXX_FLAGS_${BUILD_TYPE_UPPER}}\" -Xptxas -O4 -Xcompiler -O4")
    endif()
    ...
    if(DEFINED GPUCA_NO_FAST_MATH AND "${GPUCA_NO_FAST_MATH}")
      set(CMAKE_CUDA_FLAGS_${BUILD_TYPE_UPPER} "${CMAKE_CUDA_FLAGS_${BUILD_TYPE_UPPER}} ${GPUCA_CUDA_NO_FAST_MATH_FLAGS}")
    elseif(NOT BUILD_TYPE_UPPER STREQUAL "DEBUG")
      set(CMAKE_CUDA_FLAGS_${BUILD_TYPE_UPPER} "${CMAKE_CUDA_FLAGS_${BUILD_TYPE_UPPER}} -use_fast_math --ftz=true")#
    endif()
...
if(ENABLE_HIP)
  ...
  if(hip_FOUND AND hipcub_FOUND AND rocthrust_FOUND AND rocprim_FOUND AND hip_HIPCC_EXECUTABLE AND hip_HIPIFY_PERL_EXECUTABLE)
    ...
    set(CMAKE_HIP_FLAGS_${BUILD_TYPE_UPPER} "${CMAKE_CXX_FLAGS_${BUILD_TYPE_UPPER}} ${CMAKE_HIP_FLAGS_${BUILD_TYPE_UPPER}}")
  else()
    set(HIP_ENABLED OFF)
  endif()
