...
IF(ENABLE_THREAD_SAFETY_ANALYSIS)
  set(CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}> "${CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>} -Werror=thread-safety -D_LIBCPP_ENABLE_THREAD_SAFETY_ANNOTATIONS")
ENDIF()
...
set(CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}> "${CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>} ${CMAKE_CXX_WARNINGS}")
set(CMAKE_C_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}> "${CMAKE_C_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>} ${CMAKE_C_WARNINGS}")
...
if(ENABLE_TIME_TRACE)
  set(CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}> "${CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>} -ftime-trace")
endif()

if(DEFINED ENV{O2_CXXFLAGS_OVERRIDE})
  set(CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}> "${CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>} $ENV{O2_CXXFLAGS_OVERRIDE}")
...
if(GPUCA_NO_FAST_MATH_WHOLEO2)
  ...
  set(CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}> "${CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>} -fno-fast-math -ffp-contract=off")
  set(CMAKE_C_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}> "${CMAKE_C_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>} -fno-fast-math -ffp-contract=off")
endif()

message(STATUS "Using build type: ${CMAKE_BUILD_TYPE} - CXXFLAGS: ${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_$<UPPER_CASE:${CMAKE_BUILD_TYPE}>}")
