...
TEST_CASE("bigEndianCopy: throws on misaligned destination")
{
  alignas(64) uint8_t buf[128] = {};
  uint8_t src[4] = {};
  REQUIRE_THROWS(bigEndianCopy(buf + 1, src, 1, 4));
}

TEST_CASE("bigEndianCopy: throws on overlapping ranges")
{
  alignas(64) uint8_t buf[64] = {};
  REQUIRE_THROWS(bigEndianCopy(buf, buf, 4, 4));
}
