...
Args::Args(std::initializer_list<std::string> args) : m_exeName(*args.begin()),
...
Section::Section(SourceLineInfo const& _lineInfo,
                 StringRef _name,
                 const char* const) : m_info({"invalid", static_cast<std::size_t>(-1)}, ""),
                                      m_sectionIncluded(
