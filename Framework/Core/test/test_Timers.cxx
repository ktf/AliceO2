...
WorkflowSpec defineDataProcessing(ConfigContext const& ctx)
{
  ...
  std::vector<TimerInterval> timers{{TimerInterval{2000000000, 10},
                                     TimerInterval{1000000000, 5}}};

  std::vector<InputSpec> inputs = {{{"timer"}, "TST", "TIMER", 0, Lifetime::Timer, timerIntervals(timers)}};
