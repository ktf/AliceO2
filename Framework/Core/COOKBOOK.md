...
Such streams can be enabled using the "Signpost" part of the Device Inspector GUI or alternatively 
from the command line, by specifying the `--signposts <log name>,...` option or exporting the variable `DPL_SIGNPOSTS=<log name>,...`).
