...
def expand_cmake_vars(name, src, dst, cmake_vars):
    ...
    Args:
      ...
      cmake_vars: a string containing the CMake variables, as generated by
        cmake_var_string.
    """
    expand_cmake_vars_tool = Label("@O2//third_party/llvm:expand_cmake_vars")
    native.genrule(
        name = name,
        srcs = [src],
...
llvm_all_cmake_vars = select({
    ...
    "@O2//:linux_ppc64le": cmake_var_string(
        _dict_add(
            cmake_vars,
